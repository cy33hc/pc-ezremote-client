...
#define BUTTON_L2 0x00000100
#define BUTTON_R2 0x00000200
...
static float ImGui_ImplSDL2_GameControllerGetAxis(ImGui_ImplSDL2_Data* bd, SDL_GameControllerAxis axis_no, float v0, float v1)
{
...
{
    float merged_value = ImGui_ImplSDL2_GameControllerGetAxis(bd, axis_no, v0, v1);
...
static void ImGui_ImplSDL2_UpdateGamepads()
{
    ...
    if (ImGui_ImplSDL2_GameControllerGetAxis(bd, SDL_CONTROLLER_AXIS_LEFTX, -thumb_dead_zone, -32768) > 0.0f)
        down |= BUTTON_LEFT;
    else if (ImGui_ImplSDL2_GameControllerGetAxis(bd, SDL_CONTROLLER_AXIS_LEFTX, +thumb_dead_zone, +32767)  > 0.0f)
        down |= BUTTON_RIGHT;
    else if (ImGui_ImplSDL2_GameControllerGetAxis(bd, SDL_CONTROLLER_AXIS_LEFTY, +thumb_dead_zone, +32767)  > 0.0f)
        down |= BUTTON_DOWN;
    else if (ImGui_ImplSDL2_GameControllerGetAxis(bd, SDL_CONTROLLER_AXIS_LEFTY, -thumb_dead_zone, -32768)  > 0.0f)
        down |= BUTTON_UP;
    else if (ImGui_ImplSDL2_GameControllerGetAxis(bd, SDL_CONTROLLER_AXIS_TRIGGERLEFT,  0.0f, 32767) > 0.0f)
        down |= BUTTON_L2;
    else if (ImGui_ImplSDL2_GameControllerGetAxis(bd, SDL_CONTROLLER_AXIS_TRIGGERRIGHT,  0.0f, 32767) > 0.0f)
        down |= BUTTON_R2;

    uint32_t pressed = down & ~previous_down;
    io.AddKeyEvent(ImGuiKey_F8, (pressed & BUTTON_L2) != 0);
    io.AddKeyEvent(ImGuiKey_F10, (pressed & BUTTON_R2) != 0);
    ...
    ImGui_ImplSDL2_UpdateGamepadButton(bd, io, ImGuiKey_Insert,             SDL_CONTROLLER_BUTTON_X);              // Xbox X, PS Square
    ImGui_ImplSDL2_UpdateGamepadButton(bd, io, ImGuiKey_GamepadFaceRight,   SDL_CONTROLLER_BUTTON_B);              // Xbox B, PS Circle
    ImGui_ImplSDL2_UpdateGamepadButton(bd, io, ImGuiMod_Alt,                SDL_CONTROLLER_BUTTON_Y);              // Xbox Y, PS Triangle
    ...
    ImGui_ImplSDL2_UpdateGamepadAnalog(bd, io, ImGuiKey_GamepadLStickLeft,  SDL_CONTROLLER_AXIS_RIGHTX, -thumb_dead_zone, -32768);
    ImGui_ImplSDL2_UpdateGamepadAnalog(bd, io, ImGuiKey_GamepadLStickRight, SDL_CONTROLLER_AXIS_RIGHTX, +thumb_dead_zone, +32767);
    ImGui_ImplSDL2_UpdateGamepadAnalog(bd, io, ImGuiKey_GamepadLStickUp,    SDL_CONTROLLER_AXIS_RIGHTY, -thumb_dead_zone, -32768);
    ImGui_ImplSDL2_UpdateGamepadAnalog(bd, io, ImGuiKey_GamepadLStickDown,  SDL_CONTROLLER_AXIS_RIGHTY, +thumb_dead_zone, +32767);
}
