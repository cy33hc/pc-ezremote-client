...
extern float scale_factor_x, scale_factor_y;
...
namespace Windows
{
    ...
    inline float scaleX(int value)
    {
        return (value * 1.0f) * scale_factor_x;
    }
    
    inline float scaleX(float value)
    {
        return value * scale_factor_x;
    }

    inline float scaleY(int value)
    {
        return (value * 1.0f) * scale_factor_y;
    }
    
    inline float scaleY(float value)
    {
        return value * scale_factor_y;
    }
